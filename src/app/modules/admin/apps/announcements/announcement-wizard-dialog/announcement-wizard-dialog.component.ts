...
@Component({
    selector: 'announcement-wizard-dialog',
    standalone: true,
    templateUrl: './announcement-wizard-dialog.component.html',
...
export class AnnouncementWizardDialogComponent implements OnInit {
    @ViewChild('stepper') stepper!: MatStepper;

    private _fb = inject(FormBuilder);
    private _cdr = inject(ChangeDetectorRef);
    private _dialogRef = inject(MatDialogRef<AnnouncementWizardDialogComponent>);
