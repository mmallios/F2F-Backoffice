        ...
        children: [
            ...
            // Apps
            {
                path: 'apps', children: [
                    ...
                    { path: 'events', loadChildren: () => import('app/modules/admin/apps/events/events.routes') },
                    { path: 'teams', loadChildren: () => import('app/modules/admin/apps/teams/teams.routes') },
                    { path: 'competitions', loadChildren: () => import('app/modules/admin/apps/competitions/competitions.routes') },
                    { path: 'groupchats', loadChildren: () => import('app/modules/admin/apps/groupchats/groupchats.routes') },
                    { path: 'tvchannels', loadChildren: () => import('app/modules/admin/apps/tvchannels/tv-channels.routes') },
                    ...
                    { path: 'bo-announcements', loadChildren: () => import('app/modules/admin/apps/bo-announcements/bo-announcements.routes') },
                    { path: 'support/tickets', loadChildren: () => import('app/modules/admin/apps/support/support.routes') },
                    { path: 'support/stats', loadChildren: () => import('app/modules/admin/apps/support-stats/support-stats.routes').then(m => m.SUPPORT_STATS_ROUTES) },
